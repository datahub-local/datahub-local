...
3. **AMD64 Worker — CHUWI AuBox (AMD Ryzen 7 8745HS, 48 GB RAM)**
    - High-performance mini-PC; used for compute-heavy jobs (Spark and Trino).
4. **GPU Worker — Lenovo Legion (AMD Ryzen 5 5600H, 24 GB RAM, RTX 3060M)**
    - Runs Ollama with `qwen3.5:4b` for local inference consumed by Sympozium agents.
